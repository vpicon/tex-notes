...
\vspace{3mm}
Viewing the heap as a tree, we have that the \textit{heigth}  of a node in a heap is te number of edges on the longest simple downwad path from the node to a leaf, and the \textit{height of the heap} is the height of its root. 
